    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent className="bg-[#1a1a1a] border-gray-700">
            <SelectItem value="male" className="text-gray-200 hover:bg-[#282828] focus:bg-[#282828]">Male</SelectItem>
            <SelectItem value="female" className="text-gray-200 hover:bg-[#282828] focus:bg-[#282828]">Female</SelectItem>
          </SelectContent>
        </Select>
      </div>
          ...
          <SelectContent className="bg-[#1a1a1a] border-gray-700">
            {VOICE_CATEGORIES.map(category => (
              <SelectItem 
                ...
                className="text-gray-200 hover:bg-[#282828] focus:bg-[#282828]"
              >
                {category.label}
              </SelectItem>
            ))}
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent className="bg-[#1a1a1a] border-gray-700">
            <SelectItem value="active" className="text-gray-200 hover:bg-[#282828] focus:bg-[#282828]">Active</SelectItem>
            <SelectItem value="inactive" className="text-gray-200 hover:bg-[#282828] focus:bg-[#282828]">Inactive</SelectItem>
          </SelectContent>
        </Select>
      </div>

...
interface StationFormProps {
  onSubmit: (data: Partial<ExtendedStation>) => void
  locations: Location[]
  clients: Client[]
  initialData?: ExtendedStation
}

export default function StationForm({ onSubmit, locations, clients, initialData }: StationFormProps) {
  const [formData, setFormData] = useState<Partial<ExtendedStation>>(initialData || {})
  ...
  const handleChange = (field: keyof ExtendedStation, value: any) => {
